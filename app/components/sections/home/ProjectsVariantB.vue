...
<template>
  <section ref="sectionRef" class="bg-bg-alt py-section">
    <div class="mx-auto flex max-w-[var(--max-width-content)] flex-col items-center px-8 lg:px-16">
      ...
      <!-- Heading — centrado, tipografía editorial grande -->
      <h2
        data-projects="heading"
        class="text-center font-display text-3xl leading-snug tracking-tight text-text lg:text-4xl"
      ...
      <!-- Projects grid -->
      <div class="mt-block w-full space-y-element">
        <!-- Row 1: 60/40 -->
        <div data-projects-row="1" class="grid grid-cols-1 gap-element lg:grid-cols-[3fr_2fr]">
          <NuxtLink
        ...
        <!-- Row 2: 40/60 (zigzag) -->
        <div data-projects-row="2" class="grid grid-cols-1 gap-element lg:grid-cols-[2fr_3fr]">
          <NuxtLink
      ...
      <NuxtLink
        to="/proyectos"
        data-projects="cta"
        class="mt-block font-body text-sm tracking-wide text-text-secondary hover:text-accent"
        style="opacity: 0"
      >
